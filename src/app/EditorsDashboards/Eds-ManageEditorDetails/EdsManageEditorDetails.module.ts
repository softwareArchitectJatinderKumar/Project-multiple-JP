...
import { EdsManageEditorDetailsComponent } from './EdsManageEditorDetails.component';
...
const routes: Routes = [
  {
    path: '',
    component: EdsManageEditorDetailsComponent, 
  }
]
@NgModule({
...
export class EdsManageEditorDetailsModule { }
