...
@Component({
  selector: 'app-Eds-TopMenuBar',
  templateUrl: './Eds-TopMenuBar.component.html',
  styleUrls: ['./Eds-TopMenuBar.component.scss'],standalone: false
})
export class EdsTopMenuBarComponent implements OnInit {
