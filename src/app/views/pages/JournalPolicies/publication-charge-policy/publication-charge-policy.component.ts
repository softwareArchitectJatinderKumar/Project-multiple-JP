...
export class PublicationChargePolicyComponent implements OnInit {
  ...
  constructor(private journalWebApiService: LpujournalbookService, private route: ActivatedRoute, private router: Router, private cookieService: CookieService, private StoragesServices: StorageService) { }
