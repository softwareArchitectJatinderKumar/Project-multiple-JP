...
export class SubmitManuScriptComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.currentJournalTitle = this.newJournalTitle;
  ...
  onTakeActions(rowData: Manuscript): void {
  ...
  onSelectFileEditorXY(fileUrl: string): void {
    if (fileUrl) {
  ...
  removeExternalReviewerY(index: number): void {
